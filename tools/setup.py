...
def main():
    ...
    print("""
  ######################################
  # BCE Development Environment Setup #
  ######################################

  This script will create your BCE dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your BCE project folder:
    [Arma 3 installation directory]\\{} => BCE project folder
    P:\\{}                              => BCE project folder
